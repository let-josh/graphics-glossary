...
<Tabs>
	<TabItem label="both">
		...
		and textures both enabled](../../src/assets/pokemon-snap/beach.png)
	</TabItem>
	<TabItem label="textures only">
		![a screenshot of the beach location from pokemon snap with textures enabled
		and vertex coloring disabled](../../src/assets/pokemon-snap/beach-textures.png)
	</TabItem>
	<TabItem label="vertex coloring only">
		![a screenshot of the beach location from pokemon snap with vertex coloring
		enabled and textures disabled](../../src/assets/pokemon-snap/beach-vertex-colors.png)
	</TabItem>
</Tabs>
